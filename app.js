...
function flipMyCard() {
  ...
  if (this === firstCard) 
  return;
    // Den har med CSS att göra rotateY(180deg)
...
function checkForMatch() {
  //här jämföra vi 2 card på framework 
  let isMatch = firstCard. dataset.framework === secondCard.dataset.framework;
  //ternary operator  om isMatch är true remote vi eventListener, annarsremote vi classen 
...
scoreCounter.innerText=time;
let movesCounter=document.querySelector('#moves');
movesCounter.innerText=time;

}

let button=document.querySelector('#restartBtn')
